            ...
            <div className="min-h-screen bg-zinc-50">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
                    <div className="animate-pulse">
                        <div className="h-8 bg-zinc-200 rounded w-1/4 mb-6"></div>
            ...
            <div className="bg-white border-b border-zinc-200">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="py-6">
                        ...
                        <p className="mt-1 text-zinc-600">Manage quote requests and customer inquiries</p>
                    </div>
                </div>
            </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
                    <Card>
                        <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
                            <CardTitle className="text-sm font-medium text-zinc-600">Pending Quotes</CardTitle>
                            <Clock className="h-4 w-4 text-yellow-600" />
                        </CardHeader>
                        <CardContent>
                            <div className="text-2xl font-bold text-black">{pendingContacts.length}</div>
                            <p className="text-xs text-zinc-600">Awaiting response</p>
                        </CardContent>
                    </Card>

                    <Card>
                        <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
                            <CardTitle className="text-sm font-medium text-zinc-600">Responded</CardTitle>
                            <CheckCircle className="h-4 w-4 text-blue-600" />
                        </CardHeader>
                        <CardContent>
                            <div className="text-2xl font-bold text-black">{respondedContacts.length}</div>
                            <p className="text-xs text-zinc-600">Quotes sent</p>
                        </CardContent>
                    </Card>

                    <Card>
                        <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
                            <CardTitle className="text-sm font-medium text-zinc-600">Archived</CardTitle>
                            <Archive className="h-4 w-4 text-zinc-600" />
                        </CardHeader>
                        <CardContent>
                            <div className="text-2xl font-bold text-black">{archivedContacts.length}</div>
                            <p className="text-xs text-zinc-600">Completed requests</p>
                        </CardContent>
                    </Card>
                </div>
            </div>
                    ...
                    {contactRequests.length > 0 ? (
                                        ...
                                        <div className="flex-1">
                                                ...
                                                <div className="flex items-center space-x-3">
                                                    ...
                                                    <div>
                                                        ...
                                                        <div className="flex items-center space-x-4 mt-1">
                                                            <span className="text-sm text-zinc-600">{contact.serviceType}</span>
                                            ...
                                            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-4">
                                                {contact.company && (
                                                    <div>
                                                        ...
                                                        <div className="text-sm text-zinc-600">{contact.company}</div>
                                                    </div>
                                                )}
                                                ...
                                                {contact.timeline && (
                                                    <div>
                                                        ...
                                                        <div className="text-sm text-zinc-600">{contact.timeline}</div>
                                                    </div>
                                                )}
                                                ...
                                                {contact.budget && (
                                                    <div>
                                                        ...
                                                        <div className="text-sm text-zinc-600">{contact.budget}</div>
                                                    </div>
                                                )}
                                            </div>
                                            ...
                                            {contact.projectType && (
                                                <div className="mt-4">
                                                    ...
                                                    <div className="text-sm text-zinc-600">{contact.projectType}</div>
                                                </div>
                                            )}
                                        </div>
                        ...
                        <Card>
                            <CardContent className="p-12 text-center">
                                ...
                                <h3 className="text-lg font-medium text-zinc-900 mb-2">No Contact Requests</h3>
                                <p className="text-zinc-500">Contact requests will appear here once customers submit them.</p>
                            </CardContent>
                        </Card>
                    )}
                </div>
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div>
                                    ...
                                    <div className="space-y-3">
                                        <div>
                                            <div className="text-sm font-medium text-zinc-600">Name</div>
                                            <div className="text-sm text-black">{selectedContact.name}</div>
                                        </div>
                                        <div>
                                            <div className="text-sm font-medium text-zinc-600">Email</div>
                                        ...
                                        {selectedContact.company && (
                                            <div>
                                                <div className="text-sm font-medium text-zinc-600">Company</div>
                                ...
                                <div>
                                    ...
                                    <div className="space-y-3">
                                        <div>
                                            <div className="text-sm font-medium text-zinc-600">Service Type</div>
                                            <div className="text-sm text-black">{selectedContact.serviceType}</div>
                                        </div>
                                        {selectedContact.projectType && (
                                            <div>
                                                <div className="text-sm font-medium text-zinc-600">Project Type</div>
                                                <div className="text-sm text-black">{selectedContact.projectType}</div>
                                            </div>
                                        )}
                                        {selectedContact.timeline && (
                                            <div>
                                                <div className="text-sm font-medium text-zinc-600">Timeline</div>
                                                <div className="text-sm text-black">{selectedContact.timeline}</div>
                                            </div>
                                        )}
                                        {selectedContact.budget && (
                                            <div>
                                                <div className="text-sm font-medium text-zinc-600">Budget</div>
                                ...
                                <div className="flex justify-between items-center text-sm">
                                    <div className="flex items-center space-x-4">
                                        <div className="flex items-center space-x-1">
                                            ...
                                            <span className="text-zinc-600">Submitted: {formatDate(selectedContact._creationTime)}</span>
                                        </div>
